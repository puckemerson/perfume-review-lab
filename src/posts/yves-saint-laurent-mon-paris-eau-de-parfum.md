---
product_name: "Yves Saint Laurent Mon Paris Eau de Parfum"
slug: "yves-saint-laurent-mon-paris-eau-de-parfum"
date: "2026-05-07T16:03:27.967Z"
final_score: 77
categories:
  - name: "Scent Composition & Character"
    weight: 0.35
    score: 82
    rationale: "Mon Paris presents a sweet, fruity-floral profile with prominent strawberry and raspberry notes layered over white florals. The composition is assertively romantic and youthful, though the sweetness may feel cloying to those preferring more restrained fragrances."
  - name: "Longevity & Projection"
    weight: 0.25
    score: 78
    rationale: "I find the performance respectable for an eau de parfum concentration, with noticeable projection for the first few hours and reasonable skin presence throughout the day. It doesn't match the endurance of some heavier orientals, but holds its own in the designer floral category."
  - name: "Versatility & Wearability"
    weight: 0.2
    score: 65
    rationale: "The pronounced sweetness and romantic character make this best suited for evening wear and cooler weather. I wouldn't reach for it in professional settings or summer heat, which narrows its practical versatility compared to more adaptable fragrances."
  - name: "Bottle Design & Presentation"
    weight: 0.1
    score: 88
    rationale: "The bottle maintains YSL's luxury aesthetic with a substantial glass design and decorative fabric detail around the neck. The presentation feels appropriately premium for the price point and makes for an attractive display piece."
